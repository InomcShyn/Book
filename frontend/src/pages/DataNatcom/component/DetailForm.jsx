...
function DetailForm(props) {
  ...
  const natcomSourceId = Form.useWatch("natcomSourceId", form);
  ...
  return (
    <>
      <Modal
        title={title + t("menu.data_natcom")}
        open={open}
        onCancel={onCancel}
        width="45%"
        onOk={() => form.submit()}
      ...
      >
        ...
        >
          <Row gutter={(20, 20)}>
            <Col xs={24} sm={12}>
              <SelectService name="serviceId" value={serviceId} required />
            </Col>
            <Col xs={24} sm={12}>
              <SelectAssociate name="orgId" value={orgId} required />
            </Col>
          </Row>
